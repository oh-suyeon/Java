...
public class SelfTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("탄수화물 중독 자가진단 테스트입니다.");
		System.out.println("해당되는 항목에는 1을, 그렇지 않은 항목에는 0을 입력해주세요.");
		System.out.println("*****************************************");
		...
		int sum = a + b + c + d + e + f + g + h + r + j;
		
		System.out.println("*****************************************");
		if (sum >= 7) {
			System.out.println("당신의 점수는 " + sum + "점 입니다.\n" + "중독! 전문의 상담이 필요합니다.");
		} else if (sum == 3) {
			System.out.println("당신의 점수는 " + sum + "점 입니다.\n" + "주의! 위험한 수준은 아니지만 관리가 필요합니다.");
		} else if (sum < 3) {
			System.out.println("당신의 점수는 " + sum + "점 입니다.\n" + "탄수화물을 건강하게 섭취하고 있습니다.");
		} else {
			System.out.println("당신의 점수는 " + sum + "점 입니다.\n" + "위험! 탄수화물 섭취를 줄이기 위한 식습관 개선이 필요합니다.");
		}
