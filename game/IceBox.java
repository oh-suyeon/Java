...
public class IceBox extends OutMonster{
	...
	void monsterInfo(OutCharacter c){
		...
		System.out.println("<얼음 속에 무언가 들어있습니다.>");
		System.out.println("--------------------------------");
	...
	void interact(OutCharacter c){			
		...
		while(true){
			...
			switch(input2){
			case 1: System.out.println("<누군가의 눈>"); attack(c); break finding;
			case 2: System.out.println("<누군가의 귀>"); attack(c); break finding;
			case 3: System.out.println("<누군가의 손가락>"); attack(c); break finding;
	...
	void dropItem2(OutCharacter c){
		System.out.println("<누군가의 운전면허증을 획득했습니다.>");
